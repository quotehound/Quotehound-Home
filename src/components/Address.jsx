...
class Address extends Component {
  ...
  nextStep = (values) =>  { 
   ...
   const claims = urlParams.get('any_claims_over_last_3_years');
        ...
        this.props.history.push('/credit' + '?zip_code=' + zip + '&currently_insured=' + status + '&type_of_property=' + type + '&own_or_rent=' + ownership + '&number_of_rooms=' + num + '&year_house_was_built=' + built + '&size_in_square_feet=' + size + '&gender=' + gender + '&month=' + month + '&date=' + date + '&year=' + year + '&any_claims_over_last_3_years=' + claims + '&address=' + address)
    }
