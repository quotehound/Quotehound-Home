...
class Footer extends Component {
    ...
    render() {
        ...
        return(
          ...
          <p className="text-sm text-center text-gray-500"> This is a commercial site designed for the solicitation of insurance from selected Home insurance carriers. It is not an insurer, an insurance agency. Insurance agency services may be provided by a partner licensed agency. This site is not maintained by or affiliated with the federal government’s Home Insurance Marketplace website or any state government home insurance marketplace</p>
          </div>
        </section>
