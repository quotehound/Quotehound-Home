...
class Year extends Component {
 ...
 this.props.setDOB(month + '/' + date + '/' + year)
        ...
        this.props.history.push('/claims' + '?zip_code=' + zip + '&currently_insured=' + status + '&type_of_property=' + type + '&own_or_rent=' + ownership + '&number_of_rooms=' + num + '&year_house_was_built=' + built + '&size_in_square_feet=' + size + '&gender=' + gender + '&month=' + month + '&date=' + date + '&year=' + year)
    }
